# -*- coding: utf-8 -*-
"""
Created on Thu Mar 25 21:31:45 2021
...
etiquetaUmbral.place(x= marginX, y=110)
entradaUmbral = tk.Entry(root, textvariable=tk_umbral)
entradaUmbral.place(x = marginX + 150, y = 110, width=entryWidth)
#UI_AplicarMascara
